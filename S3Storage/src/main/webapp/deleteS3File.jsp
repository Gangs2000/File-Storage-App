                ...
                <table class="table table-striped table-hover table-bordered" style="background-color:white">
                    <thead>
                        <tr class="success" align="center">
                            <th scope="col" colspan="6" style="padding:25px; background-color: black; color: white;"><i class="fab fa-aws"></i>&nbsp;&nbsp;Uploaded files ( Fetched records from AWS S3 )</th>
                        </tr>
                        <tr class="danger" align="center">
                            <th scope="col" style="padding:20px; width:15%;">File Name</th>                                    
                            <th scope="col" style="padding:20px; width:20%;">Original File Name</th>
                            <th scope="col" style="padding:20px; width:15%;">Region</th>
                            <th scope="col" style="padding:20px; width:15%;">File Type</th>                            
                            <th scope="col" style="padding:20px; width:15%;">File Size</th>                            
                    ...
                    <tbody>
                        <c:forEach items="${editFiles}" var="editFiles">  <!-- In order to use this forEach we need import jstl dependencies --> 
                            <tr class="info" align="center">              
                                ...
                                <td><a href="/delete-s3-file/fileId/${editFiles.id}"><button class="btn btn-danger" style="width: 80%;"><i class="fas fa-trash-alt"></i>&nbsp;&nbsp;<strong>Delete</strong></button></a></td>
                            </tr>                            
                        </c:forEach>
                    </tbody>
                </table>             
