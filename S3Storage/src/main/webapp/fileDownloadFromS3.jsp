...
<body>
    <h4 style="color: white; position: fixed;">AWS S3 Files available to download&nbsp;&nbsp;<i class="fas fa-cloud-download-alt"></i></h4><br><br><br>
                ...
                <c:forEach items="${downloadFiles}" var="downloadFiles">  <!-- In order to use this forEach we need import jstl dependencies -->
    			    <td scope="row">
    			        <div class="card" style="width: 20rem; height:30rem; overflow:auto">
                            <img src="awss3.jpeg" class="card-img-top">
                                ...
                                <a href="/download-s3-file/fileId/${downloadFiles.id}">
                                    <button class="btn btn-primary" style="width:100%; font-weight:bold;">
                                        <div class="card-footer">
                                            <i class="fas fa-cloud-download-alt"></i></i>&nbsp;&nbsp;Download
                                        </div>
                                    </button>
                                </a>
                                </div>
