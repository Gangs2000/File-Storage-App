            ...
            <div class="card" style="border-radius: 1rem;">
              <div class="row g-0">
                <div class="col-md-6 col-lg-5 d-none d-md-block">
                  <img src="mongoatlas.png" alt="login form" class="img-fluid" style="width:100%; height:100%; border-radius: 1rem 0 0 1rem;" />
                </div>
                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                  <div class="card-body p-4 p-lg-5 text-black" style="background-color:#00E6F6; border-radius: 1rem">

                    <form action="/uploadToMongo" method="post" name="mongodb" enctype="multipart/form-data">

                      <div class="d-flex align-items-center mb-3 pb-1">
                        <i class="fas fa-cubes fa-2x me-3" style="color: #ff6219;"></i>
                        <span class="h2 fw-bold mb-0">Upload File to MongoDB Atlas</span>
                      </div>

                      <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Select and Upload file into MongoDB</h5>
                      ...
                      <div class="pt-1 mb-4">
                        <button class="btn btn-dark btn-md btn-block" type="submit"><i class="fas fa-upload"></i>&nbsp;&nbsp;Upload To MongoDB Atlas</button>&nbsp;&nbsp;
                      </div>
                    </form>
                  </div>
                </div>
